...
adata_vis = sc.read_h5ad(spatial_file_path) ## ZJW EDIT
#adata_vis = sc.read_visium(spatial_file_path) ## ZJW EDIT
...
#cell2location.models.Cell2location.view_anndata_setup(adata=data_vis)
